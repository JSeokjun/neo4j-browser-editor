...
const icons = {
  ...
  Delete:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g class="icon"><defs><style>.a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}</style></defs><title>Delete</title><path class="a" d="M3.75,6.75h16.5"/><path class="a" d="M9.75,3.75h4.5a1.5,1.5,0,0,1,1.5,1.5V6.75H8.25V5.25A1.5,1.5,0,0,1,9.75,3.75Z"/><path class="a" d="M6.75,6.75h10.5l-.75,12a1.5,1.5,0,0,1-1.5,1.5H9a1.5,1.5,0,0,1-1.5-1.5Z"/><line class="a" x1="10" y1="10" x2="10" y2="17"/><line class="a" x1="14" y1="10" x2="14" y2="17"/></g></svg>',
  Create:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g class="icon"><defs><style>.a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}</style></defs><title>Create</title><circle class="a" cx="6" cy="12" r="2.25"/><circle class="a" cx="18" cy="12" r="2.25"/><line class="a" x1="8.25" y1="12" x2="12.75" y2="12"/><line class="a" x1="15.25" y1="12" x2="15.75" y2="12"/><line class="a" x1="14" y1="9.75" x2="14" y2="14.25"/></g></svg>'
}
